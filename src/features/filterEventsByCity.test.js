...
defineFeature(feature, (test) => {
  ...
  // Тест 1: Показ усіх подій, якщо користувач не шукав місто
  ...
  // Тест 2: Користувач бачить список підказок при введенні міста
  test("User should see a list of suggestions when they search for a city.", ({
    ...
    when("user starts typing in the city textbox", async () => {
      ...
      await waitFor(() => {
        if (!CitySearchDOM) throw new Error("CitySearch component not found");
      });
  ...
  // Тест 3: Користувач може вибрати місто зі списку підказок
